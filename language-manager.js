document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        en: {
            ...
            animalInfoIntro: 'This test predicts a dog/cat vibe from a photo or camera view. It is for fun and reference only, not identification.',
        ...
        ko: {
            ...
            animalInfoIntro: '이 테스트는 사용자가 제공한 사진 또는 카메라 화면을 기반으로 강아지상/고양이상 분위기를 예측합니다. 재미와 참고를 위한 결과이며, 과학적 진단이나 신원 판별 목적이 아닙니다.',
        ...
        ja: {
            ...
            animalInfoIntro: '写真やカメラ映像から犬/猫っぽさを予測します。娯楽・参考用で、識別目的ではありません。',
